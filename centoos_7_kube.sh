...
#=================================================================================================================================
# 6. Conigure the Docker Cgroup Driver to systemd, enable and start Docker
#=================================================================================================================================
...
#confirmation of master node
        ...
        read -p "is this a master node? y or n?"  -r
                ...
                then
#=================================================================================================================================
# 10.a Initialize the cluster using the IP range for Flannel.
#=================================================================================================================================

        kubeadm init --pod-network-cidr=10.244.0.0/16

#=================================================================================================================================
# 11.a Exit sudo and Copy the kubeadmin join command.
#=================================================================================================================================
...
#=================================================================================================================================
# 10.b Run the join command that you copied earlier (this command needs to be run as sudo), then check your nodes from the master.
#=================================================================================================================================

        kubectl get nodes

#=================================================================================================================================
# 11.b Print finished to let user know script is complete
#=================================================================================================================================
